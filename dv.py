...
with open('DanielleDV27_tweets.csv') as csvDataFile:
...
my_df.to_csv('DanielleDV27tweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(count)
my_df.to_csv('DanielleDV27retweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(likecount)
my_df.to_csv('DanielleDV27likesmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
