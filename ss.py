...
with open('SushmaSwaraj_tweets.csv') as csvDataFile:
...
my_df.to_csv('SushmaSwarajtweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(count)
my_df.to_csv('SushmaSwarajretweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(likecount)
my_df.to_csv('SushmaSwarajlikesmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
