...
with open('msdhoni_tweets.csv') as csvDataFile:
...
my_df.to_csv('msdhonitweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(count)
my_df.to_csv('msdhoniretweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(likecount)
my_df.to_csv('msdhonilikesmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
