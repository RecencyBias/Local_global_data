...
with open('RanveerOfficial_tweets.csv') as csvDataFile:
...
my_df.to_csv('ranveertweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(count)
my_df.to_csv('ranveernretweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(likecount)
my_df.to_csv('ranveerlikesmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
