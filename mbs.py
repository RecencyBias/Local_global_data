...
my_df.to_csv('malaysirweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(count)
my_df.to_csv('malaysirretweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(likecount)
my_df.to_csv('malaysirlikesmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
