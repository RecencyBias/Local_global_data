...
with open('sachin_rt_tweets.csv') as csvDataFile:
...
my_df.to_csv('sachin_rt_tweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(count)
my_df.to_csv('sachinretweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(likecount)
my_df.to_csv('sachinlikesmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
