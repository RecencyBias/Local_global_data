...
with open('Javedakhtarjadu_tweets.csv') as csvDataFile:
...
my_df.to_csv('javedtweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(count)
my_df.to_csv('javedretweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(likecount)
my_df.to_csv('javedlikesmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
