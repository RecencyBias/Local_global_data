...
with open('ABdeVilliers17_tweets.csv') as csvDataFile:
...
my_df.to_csv('abdtweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(count)
my_df.to_csv('abdretweetsmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
my_df = pd.DataFrame(likecount)
my_df.to_csv('abdlikesmonthwise.csv', index=False, header=False) #first col is monthwise the no of tweets
